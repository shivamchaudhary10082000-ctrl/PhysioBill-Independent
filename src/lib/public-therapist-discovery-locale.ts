...
const copy: Record<SupportedLocale, PublicTherapistDiscoveryCopy> = {
  'en-IN': {
    loadingVerifiedPhysiotherapists: 'Loading credential-checked physiotherapists',
    verifiedProfessional: 'Credential checked',
    verifiedRegistration: 'Credential details checked',
    services: 'Services',
    ...
    verifiedCareOptions: (city) => `Credential-checked care options for ${city}.`,
    ...
    verifiedTherapistSearch: 'Credential-checked therapist search',
    verifiedPhysiotherapists: 'Credential-checked physiotherapists',
    startWithCity: 'Start with your city',
    noVerifiedMatches: (city) => `No credential-checked matches in ${city} yet`,
    ...
    noVerifiedPhysiotherapists: 'No credential-checked physiotherapists are listed for this search yet.',
  ...
  'hi-IN': {
    loadingVerifiedPhysiotherapists: 'क्रेडेंशियल-जाँचे गए फिजियोथेरेपिस्ट लोड हो रहे हैं',
    verifiedProfessional: 'क्रेडेंशियल जाँचा गया',
    verifiedRegistration: 'क्रेडेंशियल विवरण जाँचा गया',
    services: 'सेवाएँ',
    ...
    verifiedCareOptions: (city) => `${city} के लिए क्रेडेंशियल-जाँचे गए देखभाल विकल्प।`,
    ...
    verifiedTherapistSearch: 'क्रेडेंशियल-जाँचे गए फिजियोथेरेपिस्ट खोज',
    verifiedPhysiotherapists: 'क्रेडेंशियल-जाँचे गए फिजियोथेरेपिस्ट',
    startWithCity: 'अपने शहर से शुरू करें',
    noVerifiedMatches: (city) => `${city} में अभी कोई क्रेडेंशियल-जाँचा गया मैच नहीं`,
    ...
    noVerifiedPhysiotherapists: 'इस खोज के लिए अभी कोई क्रेडेंशियल-जाँचा गया फिजियोथेरेपिस्ट सूचीबद्ध नहीं है।',
  ...
  'gu-IN': {
    loadingVerifiedPhysiotherapists: 'ક્રેડેન્શિયલ-ચકાસાયેલ ફિઝિયોથેરાપિસ્ટ લોડ થઈ રહ્યા છે',
    verifiedProfessional: 'ક્રેડેન્શિયલ ચકાસાયેલ',
    verifiedRegistration: 'ક્રેડેન્શિયલ વિગતો ચકાસાયેલ',
    services: 'સેવાઓ',
    ...
    verifiedCareOptions: (city) => `${city} માટે ક્રેડેન્શિયલ-ચકાસાયેલ કાળજી વિકલ્પો.`,
    ...
    verifiedTherapistSearch: 'ક્રેડેન્શિયલ-ચકાસાયેલ ફિઝિયોથેરાપિસ્ટ શોધ',
    verifiedPhysiotherapists: 'ક્રેડેન્શિયલ-ચકાસાયેલ ફિઝિયોથેરાપિસ્ટ',
    startWithCity: 'તમારા શહેરથી શરૂ કરો',
    noVerifiedMatches: (city) => `${city} માં હાલમાં કોઈ ક્રેડેન્શિયલ-ચકાસાયેલ મેચ નથી`,
    ...
    noVerifiedPhysiotherapists: 'આ શોધ માટે હાલમાં કોઈ ક્રેડેન્શિયલ-ચકાસાયેલ ફિઝિયોથેરાપિસ્ટ સૂચિબદ્ધ નથી.',
