    ...
    <div className="min-h-screen bg-background">
      <header className="sticky top-0 z-20 border-b border-border bg-background/92 backdrop-blur-md">
        <div className="mx-auto flex h-[70px] max-w-6xl items-center justify-between gap-3 px-4 sm:px-7">
          <a href={isPatient ? '/patient' : '/app/dashboard'}>
      ...
      <main className="mx-auto max-w-6xl px-4 pb-24 pt-6 sm:px-7">
        <a href={isPatient ? '/patient' : '/app/dashboard'} className="mb-5 inline-flex items-center gap-2 rounded-xl px-2 py-2 text-sm font-medium text-muted-foreground hover:bg-secondary hover:text-foreground">
          <ArrowLeft size={16} /> {isPatient ? 'Back to patient gateway' : 'Back to Overview'}
        </a>
